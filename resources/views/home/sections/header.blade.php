                                        ...
                                        @foreach($parentCategories as $parentCategory)
                                            <li>
                                                ...
                                                @foreach($parentCategory->children as $children)
                                                    <ul>
                                                        <li><a href="{{route ('home.categories.show',['category'=>$children->slug] )}}">{{$children->name}}</a></li>
                                                    </ul>
                                                @endforeach
                                            </li>
                                        @endforeach
                                ...
                                <ul>
                                    @if(! \Cart::isEmpty())
                                        @foreach(\Cart::getContent() as $item)
                                            <li class="single-shopping-cart justify-content-between">
                                                <div class="shopping-cart-img">
                                                    <a href="#">
                                                        <img width="100px" alt="" src="{{ url(env('PUBLIC_UPLOAD_PRODUCT_IMAGES_PATH').$item->associatedModel->primary_image)}}" />
                                                    </a>
                                                ...
                                                <h4>
                                                    <a href="#"> {{$item->associatedModel->name}} </a>
                                                </h4>
                                                <span>{{$item->quantity}} x {{number_format($item->price)}}</span>
                                                    <div style="direction: rtl">
                                                        ...
                                                        @if($item->attributes->isSale)
                                                            <p lass="mb-0" style="font-size: 12px">
                                                                تخفیف
                                                                :
